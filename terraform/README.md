...
| [aws_s3_bucket_versioning.s3v](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/s3_bucket_versioning) | resource |
...
| <a name="input_key_name"></a> [key\_name](#input\_key\_name) | Nome da chave SSH provisionada previamente na AWS | `string` | `"challenge_coodesh"` | no |
| <a name="input_project"></a> [project](#input\_project) | Nome do projeto | `string` | `"Infra-Challenge-20240202-Coodesh"` | no |
| <a name="input_region"></a> [region](#input\_region) | Região da AWS onde os recursos serão provisionados | `string` | `"us-east-1"` | no |
